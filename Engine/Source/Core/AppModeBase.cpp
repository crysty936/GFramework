...
void AppModeBase::CreateInitialResources()
{
	...
	LightingTarget = D3D12RHI::Get()->CreateRenderTarget(props.Width, props.Height, L"FinalLighting", ERHITexturePrecision::UnsignedByte, ETextureState::Render_Target, ERHITextureFilter::Nearest, false);
